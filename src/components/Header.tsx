...
function Header({children, clasname } : Props) {
    ...
    <div className={twMerge("h-fit bg-gradient-to-b from-emerald-800 p-6", clasname)}>
        <div className="w-full mb-4 flex items-center justify-between">
           <div className="hidden md:flex gap-x-2 items-center">
                <button onClick={() => router.back()} className="rounded-full bg-black grid content-center hover:opacity-75 transition ">
                    <RxCaretLeft className="text-white" size={35} />
                </button>
                <button onClick={() => router.forward()} className="rounded-full bg-black grid content-center hover:opacity-75 transition ">
